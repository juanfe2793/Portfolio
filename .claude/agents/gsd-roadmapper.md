...
Reference full template: `/Users/juanfe/code/Portfolio/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/juanfe/code/Portfolio/.claude/get-shit-done/templates/state.md`.
