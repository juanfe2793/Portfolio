# Describe DMS replica instance

This script retrieve information about DMS replica instances in all regions. Here's a brief overview
...
- Defines a function called `describe_dms_instances_by_region` that takes a single argument,
  ...
  about all DMS replica instances in that region.
