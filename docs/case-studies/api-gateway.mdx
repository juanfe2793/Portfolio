...
<CaseStudyHeader
  ...
  duration="2022 – 2024"
  stack={["Kong", "Terraform", "AWS ECS Fargate", "PrivateLink", "NLB", "OpenTelemetry", "k6"]}
  impact="Became the organizational standard for cross-domain connectivity at Twilio, prepared for 3.39M+ RPS with five-nines availability."
/>
