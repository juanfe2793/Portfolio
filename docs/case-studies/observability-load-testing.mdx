...
The key decision was adopting OTel as a _sidecar_, not as a library teams had to integrate.
...
Performance tests were redesigned as _gates_ in the CI/CD pipeline, not post-deployment checks.
